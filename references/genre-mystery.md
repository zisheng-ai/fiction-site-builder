...
Load this file alongside `story-long-write.md` when writing mystery, cosy mystery, gothic, literary thriller, Regency mystery, psychological thriller, or whodunit. Skip for romance, horror, fantasy, or sci-fi without a mystery plot.

## Mystery Sub-genres

| Sub-genre | Core tension driver | Distinguishing feature |
|---|---|---|
| **Cosy Mystery** | Who did it — solved by an amateur with social access | Warm community setting; no graphic violence; intelligence as pleasure not suffering; resolution restores domestic order |
| **Gothic Mystery / Gothic Romance** | Is what she's experiencing real — and is she safe? | Setting as character; dread accumulates via uncanny ordinary; resolution may be ambiguous |
| **Literary Thriller** | What is being hidden and why — with institutional stakes | Slow-burn information asymmetry; prose restraint; implications over action |
| **Regency Mystery** | Who did it — under the constraint of period social convention | Social reputation as mortal stakes; protagonist works around her own limitations |
| **Psychological Thriller** | Can she trust her own perception — and the people around her? | Unreliable narrator or environment; interiority is the battleground |
| **Whodunit / Closed-Room Mystery** | Which of the finite suspects is the killer? | Puzzle structure; all clues present before the reveal; fair-play contract with reader |
...
Mystery and thriller require **tension + question** but not desire. Gothic requires tension + atmospheric dread (desire is optional). Regency mystery follows the standard but filters desire through period social constraint — it is present but displaced into gesture, language, and proximity rather than stated directly.

**The one-paragraph test:** the opening paragraph must make the reader feel something in the first three sentences. If the answer is only "I understand where we are" — the scene starts too early. Mystery opens in the middle of the wrong thing already happening — not in the setup to it.
...
## Environmental Drama (Mystery)

The setting is not backdrop. Before writing any scene, ask: *does this location make the truth harder or easier to find?*
...
### Investigation Beat Structure

For mystery / suspense short form, use the investigation beat structure instead of the standard misdirection beats:
...
The key difference: clues are **found inside other scenes** (they piggyback on action the story already needed), not in dedicated "I search for clues" scenes.
...
## Synopsis Formula J — Mystery / Whodunit
